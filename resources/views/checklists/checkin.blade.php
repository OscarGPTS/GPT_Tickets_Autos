...
<div class="form-wrapper">
    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-6 main-container">
        ...
        <form action="{{ route('checklists.checkin.store', $ticket) }}" method="POST" id="checkinForm" onsubmit="return validateForm()">
            @csrf
            ...
            <table class="w-full mb-6 border border-black rounded-lg text-xs sm:text-sm" style="min-width: 800px;">
                ...
                <tr>
                    ...
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        <input type="text" name="placas" value="{{ old('placas', $ticket->vehicle->plates) }}" class="w-full border-gray-300 rounded table-input bg-gray-50" readonly required>
                    </td>
                ...
                <tr>
                    ...
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        ...
                        <input type="hidden" name="kilometraje_inicial" value="{{ $checkoutChecklist ? $checkoutChecklist->kilometraje_inicial : 0 }}">
                    </td>
                    ...
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        <select name="nivel_combustible_final" class="w-full border-gray-300 rounded table-input" required>
                            ...
                            @php
                                $defaultCombustible = old('nivel_combustible_final', $checkoutChecklist->nivel_combustible_inicial ?? '');
                            @endphp
                            <option value="1/4" {{ $defaultCombustible == '1/4' ? 'selected' : '' }}>1/4</option>
                            <option value="1/2" {{ $defaultCombustible == '1/2' ? 'selected' : '' }}>1/2</option>
                            <option value="3/4" {{ $defaultCombustible == '3/4' ? 'selected' : '' }}>3/4</option>
                            <option value="Lleno" {{ $defaultCombustible == 'Lleno' ? 'selected' : '' }}>Lleno</option>
                        </select>
                        <input type="hidden" name="nivel_combustible_inicial" value="{{ $checkoutChecklist ? $checkoutChecklist->nivel_combustible_inicial : '' }}">
                    </td>
                </tr>
                ...
                @php
                    $checkoutData = $checkoutChecklist ?? null;
                @endphp
                ...
                <tr>
                    <td class="border border-gray-200 table-cell-text" colspan="12">
                        <textarea name="mantenimiento_preventivo" rows="3" class="w-full border-gray-300 rounded table-input" placeholder="Describa el mantenimiento preventivo realizado...">{{ old('mantenimiento_preventivo', $checkoutData->mantenimiento_preventivo ?? '') }}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="border border-gray-200 table-cell-text" colspan="12">
                        <textarea name="mantenimiento_correctivo" rows="3" class="w-full border-gray-300 rounded table-input" placeholder="Describa el mantenimiento correctivo realizado...">{{ old('mantenimiento_correctivo', $checkoutData->mantenimiento_correctivo ?? '') }}</textarea>
                    </td>
                </tr>
                    ...
                    <td class="border border-gray-200 table-cell-text" colspan="12">
                        <div class="mb-3">
                            ...
                            <div class="mb-3 flex justify-end">
                                <button type="button" onclick="toggleFullscreen()" class="bg-orange-600 text-white px-3 py-2 sm:px-4 sm:py-2 rounded hover:bg-orange-700 text-sm">
                        ...
                        <textarea name="condicion_carroceria_log" rows="3" class="w-full border-gray-300 rounded table-input" placeholder="Describa detalladamente los daños marcados en la imagen (ej: 1. Rayón en puerta delantera izquierda, 2. Abolladura en cofre...)">{{ old('condicion_carroceria_log', $checkoutData->condicion_carroceria_log ?? '') }}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="border border-gray-200 table-cell-text" colspan="6">
                        <input type="text" name="responsable_recibo_uso" value="{{ old('responsable_recibo_uso', auth()->user()->name) }}" class="w-full border-gray-300 rounded table-input" placeholder="Nombre del responsable" required>
                    </td>
                    <td class="border border-gray-200 table-cell-text" colspan="6">
                        <input type="text" name="responsable_entrega" value="{{ old('responsable_entrega', $ticket->user->name) }}" class="w-full border-gray-300 rounded table-input" placeholder="Nombre del responsable" required>
                    </td>
                </tr>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-4">
                ...
                <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 sm:px-6 rounded-lg transition duration-200 text-sm sm:text-base">
    ...
    <div class="mt-4 sm:mt-6 bg-orange-50 border border-orange-200 rounded-lg p-3 sm:p-4">
        <h3 class="text-xs sm:text-sm font-semibold text-orange-800 mb-2">
            <i class="fas fa-info-circle mr-2"></i>Información del Checkin
        </h3>
        <ul class="text-xs sm:text-sm text-orange-700 space-y-1">
            <li>• Verifica cuidadosamente el estado del vehículo al regreso</li>
            <li>• Compara con la condición inicial del checkout</li>
