...
@section('title', 'Ver Checkout - Ticket #' . $ticket->id)
...
<div class="form-wrapper">
    ...
    <div class="bg-white rounded-lg shadow-md p-3 sm:p-6 main-container">
        <div class="flex items-center justify-between mb-3 sm:mb-4 md:mb-6">
            <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Checklist de Salida (Checkout) - Ticket #{{ $ticket->id }}</h1>
        ...
        <form id="checkoutForm">
            ...
            <table class="w-full mb-6 border border-black rounded-lg text-xs sm:text-sm" style="min-width: 800px;">
                ...
                <tr>
                    ...
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        <input type="text" value="{{ $checklist->hora_salida }}" class="w-full border-gray-300 rounded table-input bg-gray-50" readonly>
                    </td>
                    <td class="border border-gray-200 table-cell-text font-semibold title-yellow">Kilometraje Inicial</td>
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        <input type="text" value="{{ number_format($checklist->kilometraje_inicial, 2) }}" class="w-full border-gray-300 rounded table-input bg-gray-50" readonly>
                    </td>
                    <td class="border border-gray-200 table-cell-text font-semibold title-yellow">Nivel de Combustible Inicial</td>
                    <td class="border border-gray-200 table-cell-text" colspan="3">
                        <input type="text" value="{{ $checklist->nivel_combustible_inicial }}" class="w-full border-gray-300 rounded table-input bg-gray-50" readonly>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="border border-gray-200 table-cell-text" colspan="12">
                        ...
                        <div class="mb-3">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Imagen de Daños Registrados</label>
                            <div class="border-2 border-gray-300 rounded bg-white p-2">
                                <img src="{{ asset('storage/' . $checklist->condicion_carroceria_imagen) }}" 
                                     alt="Condición del vehículo" 
                                     class="w-full h-auto rounded">
                            </div>
                        </div>
                        @endif
                        <label class="block text-sm font-medium text-gray-700 mb-2">Observaciones de Daños</label>
                        <textarea rows="3" class="w-full border-gray-300 rounded table-input bg-gray-50" readonly>{{ $checklist->condicion_carroceria_log }}</textarea>
                    </td>
                </tr>
    ...
    <div class="mt-4 sm:mt-6 bg-purple-50 border border-purple-200 rounded-lg p-3 sm:p-4">
        <h3 class="text-xs sm:text-sm font-semibold text-purple-800 mb-2">
            <i class="fas fa-info-circle mr-2"></i>Información del Checkout Completado
        </h3>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Deshabilitar todos los radio buttons y seleccionar los correctos
